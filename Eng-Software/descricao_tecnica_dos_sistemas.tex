...
\begin{figure}[H]
	...
	\caption{Página Web do ePadaria: Sign in}
	\label{fig:mockup-sig-in}
\end{figure}


Ao efetuar o log in o icone "Log in" irá aparecer com o nome do cliente, para o funcionário quando entra na página do funcionário irá aparecer com o nome após o "Bem-vindo" . O funcionário para aceder ao log in tem de aceder à mesma página que o funcionário e de seguida clicar em "Log In funcionário".
